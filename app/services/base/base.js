    ...
    function getUserList() {
        ...
        return userList = {
            "userDetails": [{
                ...
                "department": "I.T",
                "salary": 1000,
                "image": "assets/img/IMG_3050.JPG"
            }, {
                "id": 2,
                "name": "Bobo",
                "department": "Project manager",
                "salary": 100000,
                "image": "assets/img/textures-selection-nice-high-resolution_2165080.jpg"
            }, {
                "id": 3,
                "name": "Baby",
                "department": "developer",
                "salary": 2000,
                "image": "assets/img/404.png"
            }, {
                "id": 4,
                "name": "Nilesh",
                "department": "Designer",
                "salary": 5500,
                "image": "assets/img/6309_1280x800.jpg"
            }, {
                "id": 5,
                "name": "amol",
                "department": "Manager",
                "salary": 100500,
                "image": "assets/img/brand-avatar.jpg"
            }, {
                "id": 6,
                "name": "ganesh",
                "department": "Accountant",
                "salary": 1000,
                "image": "assets/img/ipgeo.png"
            }]
        }
    }
    //END
